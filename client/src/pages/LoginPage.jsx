  ...
  return (
    <div className='min-h-screen bg-cover bg-center-flex flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        <h2 className='font-medium text-2xl flex justfy-between items-center'>
          {currState}
        ...
        {currState === "Sign up" && isDataSubmitted===true && (
        ...
        {currState==="Sign up"?(
          ...
          <p className='text-sm text-gray-600'>Create an account <span onClick={()=>setCurrState("Sign up")} className='font-medium text-violet-500 cursor-pointer'>Create account</span></p>
        )}
        </div>
